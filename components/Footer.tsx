...
export default function Footer() {
  return (
    <footer className="w-full bg-white mt-16 border-t border-gray-200 footer">
      {/* Upper Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-10 md:gap-y-12 gap-x-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                <FaFacebook className="h-4 w-4 text-blue-600 group-hover:text-white transition" />
              ...
              >
                <FaXTwitter className="h-4 w-4 text-black group-hover:text-white transition" />
              ...
              >
                <FaLinkedin className="h-4 w-4 text-blue-700 group-hover:text-white transition" />
