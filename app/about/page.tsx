...
const fadeInUp: Variants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: 0.6, ease: "easeOut" }, // no `as any`
  },
};
...
const fadeInLeft: Variants = {
  ...
  visible: {
    opacity: 1,
    x: 0,
    transition: { duration: 0.7, ease: "easeOut" }, // no `as any`
  },
};
    ...
    <main className="max-w-6xl mx-auto px-6 py-16 space-y-24">
      ...
      >
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          ...
          independent work in Malaysia. Together, we’re shaping the future of freelancing.
        </p>
      </motion.section>
    </main>
  );
